...
// The pawn filter should really use a CP/SAT solver and take into account which
// pawns could have promoted as well as matching pawns on the board to starting
// files.
