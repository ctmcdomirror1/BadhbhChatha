...
// Could-Have-Done:
// Replace this with constraint solver. I would have used ORTools C++. That way
// we could also receive information from check filter which restrict a pawn's
// previous move (where it must have captured etc.)
